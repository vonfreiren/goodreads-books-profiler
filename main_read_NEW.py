...
url = 'https://www.goodreads.com/review/list/136789999-javier-freire-alvarez?page=1&per_page=30&shelf=read&utf8=%E2%9C%93'
...
for i in range(1, 10):
    url = 'https://www.goodreads.com/review/list/136789999-javier-freire-alvarez?page={0}&per_page=30&shelf=read&utf8=%E2%9C%93'.format(i)
    ...
    full_name = os.path.join(save_path_books_to_read, "books" + ".json")
